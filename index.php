...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($input['run_update'])) {
        ...
        $channelFile = ($input['run_update'] === 'beta') ? 'indexbeta.php' : 'indexstable.php';

        $out = shell_exec(
            'curl -sL "https://raw.githubusercontent.com/pegakmop/neofit/refs/heads/sing-box/' . $channelFile . '" ' .
