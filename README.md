...
- Имеет минималистичный UI, доступный прямо по локальному адресу роутера и порту (пример: http://192.168.1.1:92) веб панели или в доменном имени замените https:// на https://neofit.keenetik.crazedns.ru где домен **keenetik.crazedns.ru** указан как пример для понимания
...
- **Поддержать развитие проекта:** 💳[Юмани кошелек или карта](https://yoomoney.ru/to/410012481566554)
