...
- Имеет минималистичный UI, доступный прямо по локальному адресу роутера и 92 порту веб панели или в доменном имени замените https:// на https://neofit.**домен.вашего.кинетика**
